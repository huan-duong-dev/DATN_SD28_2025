...
const adminRoutes = [
  ...
  {
    path: '/admin/san-pham/form/:id?',
    name: 'admin-san-pham-form',
    component: SanPhamFormPage,
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/san-pham/view/:id',
    name: 'admin-san-pham-view',
  ...
  {
    path: '/admin/voucher/form/:id',
    name: 'admin-voucher-form',
    component: VoucherFormPage,
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/customer-vouchers',
    name: 'admin-customer-vouchers',
  ...
  {
    path: '/admin/he-dieu-hanh',
    name: 'admin-he-dieu-hanh',
    component: HeDieuHanhPage,
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/camera-truoc',
    name: 'admin-camera-truoc',
    component: CameraTruocPage,
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/camera-sau',
    name: 'admin-camera-sau',
  ...
  {
    path: '/admin/khach-hang-sidebar',
    name: 'admin-khach-hang-sidebar',
    component: () => import('../views/KhachHangSidebarPage.vue'),
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/khach-hang/add',
    name: 'admin-khach-hang-add',
    component: () => import('../views/KhachHangAddPage.vue'),
    meta: { requiresAuth: true, role: 'STAFF' },
  },
  {
    path: '/admin/khach-hang/edit/:id',
    name: 'admin-khach-hang-edit',
  ...
  {
    path: '/admin/bao-cao-ban-hang',
    name: 'admin-bao-cao-ban-hang',
    component: BaoCaoBanHangPage,
    meta: { requiresAuth: true, role: 'MANAGER' },
  },
  {
    path: '/admin/bao-cao-ton-kho',
    name: 'admin-bao-cao-ton-kho',
    component: BaoCaoTonKhoPage,
    meta: { requiresAuth: true, role: 'MANAGER' },
  },
