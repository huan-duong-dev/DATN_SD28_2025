...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: 'san-pham-form',
      component: SanPhamFormPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/san-pham/view/:id',
      name: 'san-pham-view',
      component: SanPhamViewPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    ...
    {
      path: '/voucher/form/new',
      name: 'voucher-form-new',
      component: VoucherFormPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
    ...
    },
    {
      ...
      component: CustomerVoucherPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/dot-giam-gia',
      name: 'dot-giam-gia',
      component: DotGiamGiaPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/dot-giam-gia/form/:id',
      name: 'dot-giam-gia-form',
      component: DotGiamGiaFormPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/dot-giam-gia/form/new',
      name: 'dot-giam-gia-form-new',
      component: DotGiamGiaFormPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/dot-giam-gia/detail/:id',
      name: 'dot-giam-gia-detail',
      component: DotGiamGiaDetailPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/danh-muc',
    ...
    { path: '/pin', name: 'pin', component: PinPage, meta: { requiresAuth: true, role: 'STAFF' } },
    {
      path: '/he-dieu-hanh',
      name: 'he-dieu-hanh',
      component: HeDieuHanhPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/camera-truoc',
      name: 'camera-truoc',
      component: CameraTruocPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/camera-sau',
      name: 'camera-sau',
      component: CameraSauPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    ...
    },
    {
      ...
      name: 'khach-hang-detail',
      component: KhachHangDetailPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/khach-hang-sidebar',
      name: 'khach-hang-sidebar',
      component: () => import('../views/KhachHangSidebarPage.vue'),
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/khach-hang/add',
      name: 'khach-hang-add',
      component: () => import('../views/KhachHangAddPage.vue'),
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/khach-hang/edit/:id',
      name: 'khach-hang-edit',
      component: () => import('../views/KhachHangEditPage.vue'),
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/nhan-vien',
    ...
    },
    {
      ...
      name: 'nhan-vien-detail',
      component: ChiTietNhanVienPage,
      meta: { requiresAuth: true },
    }, // Cho phép STAFF xem chính họ
    {
      path: '/nhan-vien/sua/:id',
      name: 'nhan-vien-edit',
      component: SuaNhanVienPage,
      meta: { requiresAuth: true, role: 'MANAGER' },
    },
    {
      path: '/nhan-vien/them',
    ...
    },
    {
      path: '/giao-ca/create',
      name: 'giao-ca-create',
      component: GiaoCaCreatePage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/giao-ca/edit/:id',
      name: 'giao-ca-edit',
      component: GiaoCaCreatePage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/giao-ca/detail/:id',
      name: 'giao-ca-detail',
      component: GiaoCaDetailPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    ...
    },
    {
      path: '/phan-ca',
      name: 'phan-ca',
      component: PhanCaPage,
      meta: { requiresAuth: true, role: 'MANAGER' },
    },
    {
      path: '/phan-ca/form/:id',
      name: 'phan-ca-form',
      component: PhanCaFormPage,
      meta: { requiresAuth: true, role: 'MANAGER' },
    },
    {
      path: '/phan-ca/detail/:id',
      name: 'phan-ca-detail',
      component: PhanCaDetailPage,
      meta: { requiresAuth: true, role: 'MANAGER' },
    },
    {
    ...
    // Bảo hành routes
    {
      path: '/bao-hanh',
      name: 'bao-hanh',
      component: QuanLyBaoHanhPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/bao-hanh/tiep-nhan',
      name: 'bao-hanh-tiep-nhan',
      component: TiepNhanBaoHanhPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/bao-hanh/chi-tiet/:id',
      name: 'bao-hanh-chi-tiet',
      component: ChiTietBaoHanhPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
    {
      path: '/bao-hanh/tra-may/:id',
      name: 'bao-hanh-tra-may',
      component: TraBaoHanhPage,
      meta: { requiresAuth: true, role: 'STAFF' },
    },
  ],
})
