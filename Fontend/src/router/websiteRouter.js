...
const router = createRouter({
  ...
  routes: [
    ...
    // Google OAuth Callback (public route, không yêu cầu auth)
    {
      path: '/google-callback',
      name: 'website-google-callback',
    ...
    // Contact & News Page
    {
      path: '/tin-tuc',
      name: 'news',
      component: () => import('../views/Website/ContactNewsPage.vue'),
      meta: { public: true }
    },
    // Policies Page
    {
      path: '/chinh-sach',
      name: 'policies',
      component: () => import('../views/Website/PoliciesPage.vue'),
      meta: { public: true }
    },
    // Voucher Page
    {
      path: '/voucher',
      name: 'voucher',
      component: () => import('../views/Website/VoucherPage.vue'),
      meta: { public: true }
    },
  ],
})
