...
public class PhieuBaoHanhDTO {
    ...
    private String mauSacSku; // Màu/SKU

    // Tình trạng tiếp nhận
    private String moTaLoiKhachHang;
    private String moTaLoiNhanVien;
    private String kiemTraNhanh; // Kiểm tra nhanh (NV/KTV)
    private String tinhTrangVatLy;
    private String phuKienDiKem; // Deprecated - dùng các trường chi tiết bên dưới
    ...
    private String phuKienKhac; // Phụ kiện khác
