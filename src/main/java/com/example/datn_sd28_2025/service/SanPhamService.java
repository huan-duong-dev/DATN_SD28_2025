...
public interface SanPhamService {
    ...
    List<ChiTietSanPham> getAllChiTietSanPhamBySanPhamId(Integer sanPhamId);
    ...
    // Update chi tiet san pham status
    void updateChiTietStatus(Integer id, Integer trangThai);
}
